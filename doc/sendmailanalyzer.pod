...
configuration directive will force sa_cache to free space each week when eanbled.
...
Syslog name of Postgrey or sqlgrey. Syslog write Postgrey to maillog with the
pid as follow: ... postgrey[1234] ... and sqlgrey as follow: ... sqlgrey: ...
